      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="group relative">
            ...
            <div className="relative h-full flex flex-col bg-[#151522] border border-[rgba(120,120,255,0.12)] p-8 rounded-2xl shadow-2xl transition-all duration-300 group-hover:translate-y-[-4px]">
              ...
              <h3 className="text-2xl font-bold text-[#e8e8f0] mb-3">Krijo me AI</h3>
          ...
          <div className="group relative">
            <div className="relative h-full flex flex-col bg-[#151522] border border-[rgba(120,120,255,0.12)] p-8 rounded-2xl shadow-2xl transition-all duration-300 group-hover:translate-y-[-4px]">
              ...
              <h3 className="text-2xl font-bold text-[#e8e8f0] mb-3">Zgjidh Template</h3>
              <p className="text-[#8888aa] mb-8 flex-1">
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/dashboard"
            className="text-[#5a5a7a] hover:text-[#e8e8f0] transition-colors text-sm flex items-center justify-center gap-2 group"
          >
            Anashkalo tani
