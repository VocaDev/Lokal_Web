...
export default function PreviewHero({ customization }: PreviewHeroProps) {
  ...
  return (
    <section
      className={`${heroHeightMap[customization.hero_height || 'medium']} bg-gradient-to-br from-[var(--primary-color)] to-[var(--accent-color)] relative overflow-hidden flex flex-col items-center justify-center text-center px-4 md:px-12`}
    >
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-3xl">
        <h1 
          className="text-3xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-[1.1]"
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
          <button className="bg-white text-[var(--primary-color)] font-bold px-8 py-4 rounded-xl shadow-xl hover:shadow-2xl transition-all hover:scale-105 active:scale-95">
            View Services
          </button>
